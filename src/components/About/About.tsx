    ...
    <section id="about" className={styles.about}>
      ...
      <div className={styles.textContainer}>
        ...
        <p className={styles.firstPart}>
          Команда Evik.vin працює в галузі евакуації автомобілів вже 5 рік та
          здобула довіру тисяч клієнтів по всій Україні та за межами країни. Ми
          спеціалізуємося на наданні швидкої та професійної допомоги в
          ситуаціях, коли ви опинилися на дорозі у скрутний час.
        </p>
        <p className={styles.secondPart}>
          ...
          забезпечити його безпечну евакуацію до необхідного пункту призначення.
        </p>
        <div className={styles.achievements}>
          ...
          <div>
            ...
            <p>
              За ці роки ми успішно евакуювали 3000 автомобілів, надаючи надійну
              підтримку.
            </p>
          </div>
        </div>
